# -*- coding: utf-8 -*-
# @Time:    2024-11-05 00:03
# @Author:  Herbert·Simon
# @Email:   yonglonggeng@163.com
# @WeChat:  ddgetget
# @File:    chatbot_examples.py
# @Project: GUI-Tools
# @Package: 
...
with gr.Blocks(fill_height=True, css=custom_css) as chatbot_examples:
    chatbot = gr.Chatbot(
        elem_id="chatbot",
        ...
        examples=[
            {"icon": os.path.join(os.path.dirname(__file__), "files/avatar.png"), "display_text": "Display Text Here!",
            ...
            {"text": "Try this example with this Audio.",
             "files": [os.path.join(os.path.dirname(__file__), "files/cantina.wav")]}]
        # examples=[
        #     {"icon": "http://128.0.0.1:18000/avatar.ico", "display_text": "Display Text Here!",
        #      "text": "Try this example with this audio.",
        #      "files": [os.path.join(os.path.dirname(__file__), "files/cantina.wav")]},
        #     {"text": "Try this example with this image.",
        #      "files": [os.path.join(os.path.dirname(__file__), "files/avatar.png")]},
    ...
    chatbot.example_select(append_example_message, [chatbot], [chatbot]).then(respond, chatbot, chatbot,
                                                                              api_name="respond")

    if __name__ == "__main__":
        chatbot_examples.launch()
